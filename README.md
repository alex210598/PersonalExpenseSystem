...
Python 3.x: Il codice è scritto in Python 3 ed è compatibile con le versioni più recenti (3.8+). Non è necessario un compilatore, trattandosi di un linguaggio interpretato.
